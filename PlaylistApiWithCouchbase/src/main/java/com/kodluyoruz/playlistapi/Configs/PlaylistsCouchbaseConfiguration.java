package com.kodluyoruz.playlistapi.Configs;
...
@Configuration
public class PlaylistsCouchbaseConfiguration {
    private final CouchbaseProperties couchbaseProperties;

    public PlaylistsCouchbaseConfiguration(CouchbaseProperties couchbaseProperties) {
    ...
    @Bean
    public Collection playlistsCollection(Cluster couchbaseCluster) {
